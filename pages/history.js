...
export default function history() {
    ...
    return (
        ...
        <ListGroup.Item className={styles.historyListItem} action onClick={e => historyClicked(e, index)}>{Object.keys(historyItem).map(key => (<>{key}: <strong>{historyItem[key]}</strong>&nbsp;</>))}
